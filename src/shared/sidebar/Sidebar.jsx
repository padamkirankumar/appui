...
class Sidebar extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      moduleNames: [
        ...
        {
          parentName: "Customer Credit Notes",
          path: "/listofpendingnotes",
        ...
        {
          parentName: "Customer Debit Notes",
        ...
        {
          parentName: "Stock",
          parentImage: "icon-stock fs-30 i_icon",
          children: [
        ...
        {
          parentName: "Rebarcoading",
          parentImage: "icon-rebarcoading fs-30 i_icon",
          children: [
        ...
        {
          parentName: "Stock audits",
          parentImage: "icon-audit fs-30 i_icon",
          children: [
        ...
        },
        {
          ...
          parentImage: "icon-ecommerce fs-30 i_icon",
          children: [
        ...
        },
        {
          ...
          parentImage: "icon-user_privileges fs-30 i_icon",
          path: "/usermanagement",
          children: [
            { childName: "Create 8888 Slip", childImage: "deliveryslip",childPath: "/usermanagement"},
            { childName: "New Sale", childImage: "sale",childPath: "/usermanagement" },
            { childName: "Create Delivery Slip", childImage: "deliveryslip",childPath: "/usermanagement" },
            { childName: "Create Delivery Slip", childImage: "deliveryslip",childPath: "/usermanagement" },
          ],
        },
        {
          parentName: "Manage Masters",
          parentImage: "icon-management fs-30 i_icon",
          children: [
        ...
        {
          parentName: "Manage Promotions",
          parentImage: "icon-pramotions fs-30 i_icon",
          children: [
        ...
        {
          parentName: "Loyalty promo Settings",
          parentImage: "icon-loyalty_promo fs-30 i_icon",
          children: [
            {
              childName: "Create 223343422222 Slip",
        ...
        },
        {
          ...
          children: [
            {
              childName: "Sale Report",
              childImage: "deliveryslip",
              childPath: "/salereport",
            },
            {
              childName: "List Of Sale Bills",
              childImage: "sale",
              childPath: "/listofsalebills",
            },
            {
              childName: "List Of Delivery Slips",
              childImage: "deliveryslip",
              childPath: "/listofdeliveryslips",
            },
            {
              childName: "List Of Return Slips",
              childImage: "deliveryslip",
        ...
        {
          parentName: "Text & HSN Master",
          parentImage: "icon-hsn fs-30 i_icon",
          children: [
            {
              childName: "Create 76677666776 Slip",
              childImage: "deliveryslip",
            },
            { childName: "New Sale", childImage: "sale" },
            { childName: "Create Delivery Slip", childImage: "deliveryslip" },
  ...
  handleClick = (item, event) => {
    ...
    if (domainName.label === "TEXTILE") {
      ...
      }else if (item.parentName === "UserManagement") {
        this.props.history.push("usermanagement", { name: "returnslip" });
      }
    ...
    return (
      this.state.count > 0 && (
        <button
          ...
          onClick={() => this.setState({ slideValue: "slide-out" })}
          type="button"
        >
          <img src={bigarrow} />
        </button>
      ...
      <div className="">
        ...
        <div className="sidebar-menu">
          <ul className="">
            <li
              className="module"
              onClick={() => this.setState({ slideValue: "slide-in" })}
            >
              <i className="icon-all_modules"></i> <span>All Modules</span>{" "}
              <i className="icon-circle_arrow m-l-2"></i>
            </li>
          </ul>
            ...
            {this.state.childrenNames.map((element, index) => {
              return (
                <li
                  key={index}
                  className={
                    this.state.selectedChildName === element.childName
                      ? "active"
                      : ""
                  }
                  onClick={(e) => this.clickChild(element, e)}
                >
          ...
          <div className="slide-body">
            ...
            <ul>
              {this.state.moduleNames.map((element, index) => {
                if (
                  this.state.data["cognito:groups"][0] === "super_admin" ||
                  this.state.data["cognito:groups"][0] === "admin"
                ) {
                  return (
                    <li
                      key={index}
                      onClick={(e) => this.handleClick(element, e)}
                    >
                  ...
                  return (
                    <li
                      key={index}
                      className={index < 3 ? "" : "card-disable"}
                      onClick={(e) => this.handleClick(element, e)}
                    >
                      {/* <img className="arrow-align" src={arrow_sm} /> */}
